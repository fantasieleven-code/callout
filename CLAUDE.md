...
**V0.5.0**: 15 MCP tools, 134 tests, npm published
...
│   ├── analysis.ts    # 3工具: review, test_translate, coach
...
├── review.ts          # 6视角审查引擎 + Executive Summary
...
test/
├── server.test.ts     # 20 tests (集成测试: 15工具注册 + instructions验证)
